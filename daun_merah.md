...
- **Verifikasi live endpoint produksi masih pending** (FRED_API_KEY hanya di Vercel) — cek `GET /api/real-yields?section=labour` + kartu di tab FUNDAMENTAL setelah deploy.
