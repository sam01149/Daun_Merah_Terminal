...
- ✅ **Tab RISET** — upgrade dari panel di RINGKASAN menjadi tab tersendiri (#34d399 emerald) antara NEWS dan RINGKASAN. Sticky toolbar + filter [Semua/FED/ECB] + tombol refresh, auto-load saat pertama buka tab. Terintegrasi di top nav, bottom nav, swipe gesture, dan hideAllPanels. (2026-05-19)
