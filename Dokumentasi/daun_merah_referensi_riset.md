...
| Paper | Tipe | Temuan inti |
|---|---|---|
| [Kaminski & Lo (2014), *Journal of Financial Markets* 18, 234-254, "When do stop-loss rules stop losses?"](https://dspace.mit.edu/entities/publication/bb69ca4b-0cdc-487f-831d-63b2e84fafee) | Constraint/Method | Kerangka menilai pengurangan exposure portofolio setelah akumulasi kerugian. Abstrak artikel terverifikasi memakai daily index futures; kebijakan tertentu pada frekuensi lebih panjang dapat meningkatkan expected return dan mengurangi volatilitas. Koreksi 20 September: klaim angka ekuitas 1950-2004 sebelumnya tidak dipertahankan sebagai hasil artikel final ini. Bukan pengujian jarak SL per-entry FX atau kelipatan ATR optimal. |
...
1. **Jarak SL relatif volatilitas adalah hipotesis yang perlu diuji, bukan kesimpulan bahwa stop lebih lebar pasti lebih baik.** Koreksi 20 September: Kaminski-Lo meneliti kebijakan exposure portofolio, bukan menetapkan lantai ATR untuk SL per-entry. Ukur jarak SL/ATR, struktur harga, biaya, dan hasil pada risiko uang yang sama; detail kondisi pipeline serta eksperimen internal dirujuk ke `professional_llm_trader/riset.md`, bukan disimpulkan dari paper ini.
...
## Mekanisme TP/SL, berita, dan validasi strategi (diverifikasi 20 September 2026)

| Paper | Tipe | Temuan inti |
|---|---|---|
| [Pavel G. Savor & Mungo Ivor Wilson, "How Much Do Investors Care About Macroeconomic Risk? Evidence from Scheduled Economic Announcements", manuskrip SSRN 1312091](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1312091) | Constraint/Application | Studi return saham menemukan perbedaan hasil pada hari pengumuman ekonomi. Batas penerapan: bukan pengujian blackout entry FX 24 jam, spread universal 3-5 kali, buffer ATR tertentu, atau time-stop 48 jam. Verifikasi identitas/judul/abstrak melalui halaman manuskrip penulis; tidak disamakan dengan paper generik berjudul "Macroeconomic News Drift". |
| [Andersen, Bollerslev, Diebold & Vega (2003), "Micro Effects of Macro Announcements: Real-Time Price Discovery in Foreign Exchange", American Economic Review 93(1), 38-62](https://public.econ.duke.edu/~boller/Published_Papers/aer_03.pdf) | Constraint/Method | Data FX, ekspektasi dan realisasi rilis menunjukkan surprise menghasilkan lonjakan harga; timing dan tanda berita memengaruhi respons. Arah makro yang sudah diketahui tidak setara dengan surprise baru. |
| [Yamada & Ito (2020), "Price Discovery and Liquidity Recovery: Forex Market Reactions to Macro Announcements", NBER WP27036; versi jurnal JIMF 120 (2022)](https://www.nber.org/papers/w27036) | Constraint/Method | Pada 20 tahun data EBS, perbaikan kecepatan price discovery tidak disertai tren perbaikan pemulihan likuiditas; keduanya merupakan ukuran berbeda. |
| [Carol L. Osler (2001), "Currency Orders and Exchange-Rate Dynamics: Explaining the Success of Technical Analysis", NY Fed SR125; Journal of Finance 58(5), 1791-1819 (2003)](https://www.newyorkfed.org/research/staff_reports/sr125.html) | Method/Application | Distribusi order bank membantu menjelaskan pembalikan di support/resistance serta percepatan setelah level ditembus; respons order TP dan SL berbeda. |
| [Carol L. Osler (2002), "Stop-Loss Orders and Price Cascades in Currency Markets", NY Fed SR150; JIMF 24(2), 219-241 (2005)](https://www.newyorkfed.org/research/staff_reports/sr150.html) | Constraint/Method | Stop berkelompok dapat mempercepat pergerakan melalui umpan balik positif; dampaknya lebih besar dan lebih lama daripada TP, umumnya signifikan dalam hitungan jam, bukan hari. |
| [Kaminski & Lo (2014), "When do stop-loss rules stop losses?", Journal of Financial Markets 18, 234-254](https://dspace.mit.edu/entities/publication/bb69ca4b-0cdc-487f-831d-63b2e84fafee) | Constraint/Method | Kebijakan stop pada exposure portofolio mempunyai manfaat yang bergantung konteks; tidak menetapkan SL intraday universal. Batas cakupan dan koreksi entri lama dijelaskan pada bagian stop-loss di atas. |
| [Bailey, Borwein, Lopez de Prado & Zhu (2017), "The Probability of Backtest Overfitting", Journal of Computational Finance 20(4), 39-69](https://www.davidhbailey.com/dhbpapers/backtest-prob.pdf) | Constraint/Method | Banyak percobaan konfigurasi dapat menghasilkan pemenang historis semu. Paper mengembangkan penilaian PBO/CSCV; holdout biasa tidak selalu memadai. Tahun 2015 pada entri sebelumnya adalah versi manuskrip; publikasi final 2017 dikonfirmasi pada [direktori penulis](https://www.davidhbailey.com/dhbpapers/). |

**Implikasi untuk Daun Merah:**

1. Evaluasi timestamp dan surprise event yang benar-benar relevan; label konflik waktu saja tidak membuktikan sebab SL. Penemuan harga setelah berita tidak sama dengan likuiditas pulih. Literatur ini tidak menetapkan cooldown enam jam atau durasi tunggu lain untuk bot.
2. Sentuhan support/resistance bisa diikuti pembalikan maupun kelanjutan. Pengelompokan stop bukan bukti broker memburu SL suatu akun. Konfirmasi entry dan SL di belakang struktur merupakan kandidat uji, bukan jaminan profit; studi FX bank tidak otomatis berlaku identik pada gold spot.
3. SL lebih lebar harus dibandingkan dengan ukuran posisi lebih kecil pada risiko uang tetap. Hasil paper portofolio tidak boleh dipakai untuk menetapkan ATR multiplier optimal tanpa pengujian instrumen dan horizon yang sesuai.
4. Bandingkan keuntungan bersih, biaya, kerugian maksimum, dan hilangnya winner, bukan win rate saja. Tetapkan sedikit kandidat sebelum uji; validasi terpisah secara waktu dan hindari kebocoran trade yang tumpang tindih. Tidak ada klaim telah menjalankan CSCV hanya karena mengutip paper.
5. Rujukan ini mendukung mekanisme yang serupa, **bukan penelitian persis atas konfigurasi LLM/pair/rule proyek atau bukti bahwa sistem akan profit**. Seluruh angka histori dan eksperimen internal berada di `professional_llm_trader/riset.md` S367, tidak disalin ke daftar pustaka.
