...
- `?test_deepseek_pro=1` (2026-08-17, Call 1 saja) — bandingkan `deepseek-v4-pro` (3x harga per token vs `deepseek-v4-flash`) di data live identik. Hasil 1 sampel: pro lebih patuh aturan prompt & menangkap 1 tema tambahan, tapi 2,2x lebih lambat. Model produksi TIDAK diganti — lihat detail di [daun_merah.md](daun_merah.md) Session 317 lanjutan.
