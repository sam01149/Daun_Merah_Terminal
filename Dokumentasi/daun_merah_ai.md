...
| Google AI Studio (Gemini) — bucket `gemini_newstranslate` | 1000 request/hari, **TERPISAH** dari bucket `gemini` (200/hari) di atas | Sama 1.500 RPD (1 API key/project, ceiling dibagi bersama — 1000+200=1200 masih di bawah 1.500) | **HANYA** Translate NEWS (#10) — sengaja dipisah dari bucket `gemini` supaya volume translate (bisa ratusan/hari) tidak rebutan kuota Analisa Fundamental/AI Coach yang fallback ke `gemini` juga |
