...
### Update 2026-07-28 — Outage TLS cert expired, mitigasi fallback r.jina.ai

Insiden singkat, sudah dimitigasi — detail vendor & status terkini ada di baris tabel Proxy di atas (ScraperAPI + r.jina.ai). Kronologi & alasan teknis lengkap: `daun_merah.md` Session 249.
