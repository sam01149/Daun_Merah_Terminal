...
| ModelHub.my — gateway multi-model (dicek 2026-09-16; **BELUM DITERIMA untuk Daun Merah**) | belum ada | Gateway OpenAI-compatible ke model pihak ketiga, mencantumkan DeepSeek V4 Flash/Pro dan Qwen3.8 Max. Harga yang ditampilkan gateway: DeepSeek Flash $0,0135/$0,027 dan Qwen3.8 Max $0,4425/$1,3275 per 1 juta token input/output — cek dashboard sebelum top-up karena harga/availability dapat berubah tanpa pemberitahuan. **Jejak penggunaan pasti ada:** terms mencatat timestamp, model, token masuk/keluar, latency, status, IP, dan ID API key; homepage juga menjanjikan dashboard log per request. Prompt/respons diteruskan ke provider pihak ketiga dan dapat diproses/disimpan sementara untuk billing, keamanan, diagnostik, serta anti-abuse. Karena gateway tidak menjelaskan di halaman publik backend/provider spesifik untuk setiap rute maupun retention period, jangan kirim data kantor/pribadi sensitif dan jangan pakai key/account kantor untuk proyek pribadi. Untuk auto-entry, perlu konfirmasi tertulis jalur provider + ToS yang berlaku dan uji terisolasi lebih dahulu. [Terms & Privacy](https://www.modelhub.my/terms), [catalog & harga](https://www.modelhub.my/) |
