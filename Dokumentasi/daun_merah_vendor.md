...
|---|---|---|
| Google AI Studio (Gemini) | `GEMINI_API_KEY` | Free tier; pemakaian proyek yang pernah terukur hanya sekitar 20 request/hari untuk model flash (guard 16/hari), bukan angka 1.500 RPD yang sudah basi. Primary/satu-satunya provider Analisis Fundamental & AI Coach Jurnal sejak 2026-08-12, DITAMBAH Translate NEWS (S351-352, 2026-09-06, model `gemini-flash-lite-latest` — beda model dari Fundamental/Jurnal jadi pool kuota terpisah, lihat baris Mistral di bawah untuk alasan pindah + `daun_merah_ai.md` §item 10/§4). **Status kandidat paid 2026-09-16:** Gemini Plus user tidak memberi kredit/kuota API; paid tier perlu Cloud Billing + prepay minimal US$5/ekuivalen lokal. Profil Google Payments personal yang sama dapat dicoba, dan Google Cloud Indonesia menerima Mastercard debit/kredit; ini jalur pembayaran berbeda dari DeepSeek, bukan jaminan approval bank. Penggantian penuh DeepSeek belum dilakukan: auto-entry virtual masih perlu mode diagnostik, structured JSON + validator, serta pemisahan budget/circuit public vs eksperimental. Detail: `daun_merah_riset.md` 2026-09-16. |
