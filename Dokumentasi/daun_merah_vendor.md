...
| DeepSeek — harga resmi (dicek 2026-09-06, api-docs.deepseek.com/quick_start/pricing, per 1 juta token, USD) | — | **v4-flash**: input cache-miss $0,22 off-peak / $0,44 peak, cache-hit $0,007 / $0,014, output $0,66 / $1,32. **v4-pro**: input cache-miss $0,66 / $1,32, cache-hit $0,022 / $0,044, output $1,98 / $3,96. Peak = 01:00-04:00 & 06:00-10:00 UTC Senin-Jumat (slot auto-entry 08:15 UTC jatuh di PEAK, slot 00:15 & 13:15 off-peak). Skala biaya AATAS saat ini: Call 1 (pro) ~4,6k token input ≈ $0,006/panggilan peak, ~11 panggilan/hari ≈ $2/bulan; Call 2 (flash) ~$0,002-0,003/panggilan |
