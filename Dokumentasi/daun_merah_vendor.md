...
|---|---|---|
| Google AI Studio (Gemini) | `GEMINI_API_KEY` | Free (1.500 RPD) — dipromosikan Plan N (2026-07-18); primary/satu-satunya provider Analisis Fundamental & AI Coach Jurnal sejak 2026-08-12, DITAMBAH Translate NEWS (S351-352, 2026-09-06, model `gemini-flash-lite-latest` — beda model dari Fundamental/Jurnal jadi pool kuota terpisah, lihat baris Mistral di bawah untuk alasan pindah + `daun_merah_ai.md` §item 10/§4) (lihat catatan SambaNova di bawah) |
