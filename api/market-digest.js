...
6. LABEL TOPIK (navigasi visual untuk pembaca — BUKAN pengganti konektor di poin 2, keduanya WAJIB ada bersamaan): setiap kali fokus bergeser ke currency/tema baru, sisipkan tag PERSIS sebelum kalimat itu dengan format {{TAG: NAMA}} (NAMA = currency utama yang dibahas di situ, misal EUR, AUD/CAD, USD/JPY — bukan nama event/indikator). Jangan beri tag pada kalimat jangkar (tema utama/pembuka) atau kalimat penutup (kesimpulan kekuatan mata uang) — keduanya cukup tanpa tag. Tag ini beda dari format kalender "[EVENT] (CURRENCY) [TIME]" di bawah — jangan tertukar formatnya, dan jangan sampai menghapus kalimat konektor sebab-akibat yang sudah diwajibkan hanya karena sudah ada tag.
...
9. LABEL TOPIK (navigasi visual, BUKAN pengganti rangkaian fakta di poin 2 — keduanya WAJIB ada bersamaan): setiap kali masuk ke sub-angle baru di luar JANGKAR HARGA awal (Korelasi, Geopolitik, Positioning/skew, dst), sisipkan tag PERSIS sebelum kalimat itu dengan format {{TAG: NAMA}} (NAMA singkat, misal Korelasi, Geopolitik, Positioning). Jangan beri tag pada kalimat jangkar harga (pembuka). Tag ini beda dari format trigger kalender "[EVENT] [TIME WIB]" di bawah — jangan tertukar formatnya.
